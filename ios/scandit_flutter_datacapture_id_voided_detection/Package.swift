...
targets.insert(
    .target(
        name: "scandit_flutter_datacapture_id_voided_detection",
        dependencies: targetDeps,
        path: "Sources/scandit_flutter_datacapture_id_voided_detection"
    ),
    at: 0
)
...
let package = Package(
    ...
    products: [
        .library(
            name: "scandit-flutter-datacapture-id-voided-detection",
            targets: ["scandit_flutter_datacapture_id_voided_detection"]
        )
    ],
